...
export class PostController {
    ...
    // editting post
    @Patch(':writerId/:postId')
    async updatePost(@Param('writerId') writerId: string, @Param('postId') postId: string, @Body() body: object) {
        await this.postService.updatePost(writerId, postId, body);
